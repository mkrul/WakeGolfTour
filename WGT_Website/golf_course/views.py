...
class GolfCourseDetailView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['holes'] = Hole.objects.filter(hole_object_id = golf_course.course_id)
        context['tournaments'] = Tournaments.objects.filter(tourn_course_id = golf_course.course_id)
